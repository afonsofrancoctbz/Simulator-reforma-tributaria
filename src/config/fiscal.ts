// types.ts
import { IBS_TRANSITION_FACTOR } from '@/lib/tax-reform-rules';
...
const TRANSITION_TABLE = {
  ...
  2029: { cbs: IVA_FULL_RATE.cbs, ibs: IVA_FULL_RATE.ibs * IBS_TRANSITION_FACTOR[2029], pis_cofins_multiplier: 0, iss_icms_multiplier: 1 - IBS_TRANSITION_FACTOR[2029] }, // Using factor-based reduction
  2030: { cbs: IVA_FULL_RATE.cbs, ibs: IVA_FULL_RATE.ibs * IBS_TRANSITION_FACTOR[2030], pis_cofins_multiplier: 0, iss_icms_multiplier: 1 - IBS_TRANSITION_FACTOR[2030] },
  2031: { cbs: IVA_FULL_RATE.cbs, ibs: IVA_FULL_RATE.ibs * IBS_TRANSITION_FACTOR[2031], pis_cofins_multiplier: 0, iss_icms_multiplier: 1 - IBS_TRANSITION_FACTOR[2031] },
  2032: { cbs: IVA_FULL_RATE.cbs, ibs: IVA_FULL_RATE.ibs * IBS_TRANSITION_FACTOR[2032], pis_cofins_multiplier: 0, iss_icms_multiplier: 1 - IBS_TRANSITION_FACTOR[2032] },
  2033: { cbs: IVA_FULL_RATE.cbs, ibs: IVA_FULL_RATE.ibs * IBS_TRANSITION_FACTOR[2033], pis_cofins_multiplier: 0, iss_icms_multiplier: 1 - IBS_TRANSITION_FACTOR[2033] },
} as const;
